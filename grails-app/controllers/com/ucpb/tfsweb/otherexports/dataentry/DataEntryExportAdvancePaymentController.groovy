...
class DataEntryExportAdvancePaymentController {
	...
	// sets service type
	protected String SERVICE_TYPE = 'Export Advance Payment' 
	protected String REFERENCE_TYPE = 'Data Entry'
	protected String DOCUMENT_TYPE = 'Export'
	
    def viewExportAdvancePayment() {
	...
	def viewExportAdvancePaymentDataEntry() {
		...
		chain(action:"viewExportAdvancePayment", model: session.otherExportsModel)
	}
}
