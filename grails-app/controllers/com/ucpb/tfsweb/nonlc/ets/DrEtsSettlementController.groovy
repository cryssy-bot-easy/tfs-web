 ...
 *	Member Type: groovy
 *	Project: WEB
 *	Project Name: DrEtsSettlementController.groovy
*/
/**
 * PROLOGUE
 * SCR/ER Description:
 ...
 *	Project Name: DrEtsSettlementController.groovy
*/
class DrEtsSettlementController {
...
//        if (session.etsModel.settleFlag && "Y".equals(session.etsModel.settleFlag)) {
		...
		if(session.cancelBd){
            ...
            render(view: "/nonlc/dr/index", model: chainModel ? chainModel : session.etsModel)
        }else {
...
//            session.etsModel << [approvalMode: 'APPROVE']
    ...
    def uploadDocument() {
	////println"identify" + params.tradeServiceId
        try{
