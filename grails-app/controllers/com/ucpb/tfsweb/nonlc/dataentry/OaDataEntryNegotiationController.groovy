...
class OaDataEntryNegotiationController {
...
//			Map<String, Object> dataEntryMap = dataEntryService.getDataEntry(params.tradeServiceId)
		...
		def documentServiceRoute = routingInformationService.getNextMainApprover("OA", "FOREIGN", "", "", "DATA_ENTRY", "NEGOTIATION", session.username, session.userrole.id, session.unitcode, session.dataEntryModel, session.userLevel)
		session.nextRoute = documentServiceRoute
		session.dataEntryModel << routingInformationService.getMainApprovalMode("OA", "FOREIGN", "", "", "NEGOTIATION", session.dataEntryModel.approvers)
        ...
        def productReference = routingInformationService.getProductReferences("OA", "FOREIGN", null, null, "NEGOTIATION", session.dataEntryModel, session.unitcode, session.username)
        ...
        chain(action: "viewNegotiation", model: session.dataEntryModel)
    }
