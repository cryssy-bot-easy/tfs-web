...
/**
 * <pre>
 * Program_id    : DpDataEntrySettlementController
 * Program_name  : TFS Document Against Payment Settlement Controller
 * SCR_Number    : IBD-12-0502-01
 * Process_Mode  : WEB
 * Frequency     : Daily
 * Input         : N/A
 * Output        : N/A
 * Description   : Controller for the DP Settlement Data Entry Module
 ...
 *
 */
class DpDataEntrySettlementController {
...
//		String headerTitle = headerService.getDataEntryTitle(documentType, DOCUMENT_CLASS, null, SERVICE_TYPE + (reverseDE ? " Reversal" : ""))
		String headerTitle = reverseDE ? headerService.getNonLcReversalTitle(documentType, DOCUMENT_CLASS, SERVICE_TYPE, REFERENCE_TYPE) : headerService.getDataEntryTitle(documentType, DOCUMENT_CLASS, "", SERVICE_TYPE, "")
