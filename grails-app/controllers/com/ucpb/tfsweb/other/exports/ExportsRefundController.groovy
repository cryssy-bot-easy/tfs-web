...
class ExportsRefundController {
    ...
    private static DEFAULT_TABS = ["basicDetails", "attachedDocuments", "refundDetailsService", "modeOfRefund", "instructionsAndRouting"]
    ...
    def viewRefundEts() {
        ...
        session.etsModel << [title: "Refund of Other Export Charges - eTS",
                tabs: DEFAULT_TABS,
                serviceType: "REFUND",
        ...
        session.etsModel << [basicDetailsTab: "../product/other/exports/refund/basic_details_tab"]
        session.etsModel << [refundDetailsServiceTab: "../product/other/exports/refund/refund_details_for_charges_tab"]
        session.etsModel << [modeOfRefundTab: "../product/other/exports/refund/settlement_to_ben_tab"]
    ...
    def viewRefundDataEntry() {
        ...
        session.dataEntryModel << [title: "Refund of Other Export Charges - Data Entry",
                tabs: ["basicDetails", "attachedDocuments", "refundDetailsService", "instructionsAndRouting"],
                serviceType: "REFUND",
                documentClass: "EXPORT_CHARGES",
                documentType: "",
                documentSubType1: "",
        ...
        session.dataEntryModel << [basicDetailsTab: "../product/other/exports/refund/basic_details_tab"]
        session.dataEntryModel << [refundDetailsServiceTab: "../product/other/exports/refund/refund_details_for_charges_tab"]
    ...
    def viewRefundPayment() {
        ...
        session.chargesModel << [title: "Refund of Other Export Charges - Payment Processing",
        ...
        session.chargesModel << [basicDetailsTab: "../product/other/exports/refund/basic_details_tab"]
        session.chargesModel << [modeOfRefundTab: "../product/other/exports/refund/settlement_to_ben_tab"]
    ...
    def saveRefundEts() {
        ...
        chain(controller: "exportsRefund", action: "viewRefundEts", model: sessionModel)
    }
    ...
    def updateRefundEts() {
        ...
        chain(controller: "exportsRefund", action: "viewRefundEts", model: map)
    }
...
//                    paymentString = "<input type=\"button\" class=\"input_button_negative\" value=\"EC\" onclick=\"var id=\'" + it.ID + "\'; onReversePaymentClick(id);\"/>"
	...
	def uploadDocument() {
		...
		redirect(controller:'exportsRefund', action:'invokeUploadCommand',params:params)
	}
