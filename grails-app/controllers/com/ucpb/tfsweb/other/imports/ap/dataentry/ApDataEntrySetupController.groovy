...
class ApDataEntrySetupController {
    ...
    def viewSetupDataEntry() {
        ...
        String headerTitle = "AP Monitoring Setup - Data Entry"
	...
	def uploadDocument() {
		...
		redirect(controller:'apDataEntrySetup', action:'invokeUploadCommand',params:params)
	}
