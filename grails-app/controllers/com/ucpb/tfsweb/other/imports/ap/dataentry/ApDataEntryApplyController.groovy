...
class ApDataEntryApplyController {
    ...
    protected String SERVICE_TYPE = "Apply"
    ...
    def viewApplyDataEntry() {
        // construct header title
        String headerTitle = "AP Monitoring Application - Data Entry"
...
//        session.dataEntryModel << [nextRoute: ""]
        ...
        chain(action: "viewApply", model: session.dataEntryModel)
    }
	...
	def uploadDocument() {
		...
		redirect(controller:'apDataEntryApply', action:'invokeUploadCommand',params:params)
	}
