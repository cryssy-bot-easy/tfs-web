...
class UploadTransactionController {
	...
	def viewCdt() {
		...
		if(session.otherImportsModel) {
			...
			render(view: "/others/imports/cdt/upload_transactions/content", model: chainModel ? chainModel : session.otherImportsModel)
		}else {
