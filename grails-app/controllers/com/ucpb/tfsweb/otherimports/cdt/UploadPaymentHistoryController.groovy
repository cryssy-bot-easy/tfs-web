...
class UploadPaymentHistoryController {
	...
	def viewCdt() {
		...
		if(session.otherImportsModel) {
			...
			render(view: "/others/imports/cdt/upload_payment_history/content", model: chainModel ? chainModel : session.otherImportsModel)
		}else {
	...
	def viewUploadPaymentHistoryCdt() {
