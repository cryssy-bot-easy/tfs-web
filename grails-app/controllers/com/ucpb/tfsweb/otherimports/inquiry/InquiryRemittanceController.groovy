...
class InquiryRemittanceController {

    def headerService
	
	// sets service type
//	protected String SERVICE_TYPE = "Remittance" 
//	protected String DOCUMENT_TYPE = "Customs Duties and Taxes"
//	protected String REFERENCE_TYPE = "Inquiry"
