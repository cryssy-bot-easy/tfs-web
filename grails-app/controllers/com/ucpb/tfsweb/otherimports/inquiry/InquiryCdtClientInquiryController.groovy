...
class InquiryCdtClientInquiryController {
	...
	def viewCdtClientInquiry() {
		...
		// keep session model
		session.otherImportsModel = [documentType: documentType, referenceType: documentType, title: headerTitle, serviceType: serviceType, username: username]
