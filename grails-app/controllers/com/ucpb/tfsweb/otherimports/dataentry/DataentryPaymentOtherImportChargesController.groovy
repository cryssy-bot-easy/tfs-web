...
class DataentryPaymentOtherImportChargesController {
   ...
   def headerService
	...
	//render page
	def viewPaymentOtherImportCharges() {
	...
	def viewPaymentOtherImportChargesDataentry() {
		...
		chain(action:"viewPaymentOtherImportCharges", model: session.otherImportsModel)
	}
}
