...
class DataentryRefundOfCashLcController {
	...
	def viewRefundOfCashLcDataentry() {
		...
		chain(action:"viewRefundOfCashLc", model: session.otherImportsModel)
	}
}
