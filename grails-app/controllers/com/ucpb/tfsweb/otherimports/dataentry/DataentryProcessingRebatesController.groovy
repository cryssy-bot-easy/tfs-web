...
class DataentryProcessingRebatesController {
	...
	def viewProcessingRebatesDataentry() {
		...
		chain(action:"viewProcessingRebates", model: session.otherImportsModel)
	}
}
