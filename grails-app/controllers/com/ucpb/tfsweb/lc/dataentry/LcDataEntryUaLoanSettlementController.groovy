...
class LcDataEntryUaLoanSettlementController {
	...
	//just for testing
//	String documentType = 'FX'
//	String documentSubType1 = 'Regular'
	...
	def viewSettlementDataEntry() {
		...
		if((params.serviceType == null) || (params.serviceType.toString().equalsIgnoreCase("UA LOAN SETTLEMENT") || params.serviceType.toString().equalsIgnoreCase("UA_LOAN_SETTLEMENT"))
		...
		println "reversedDENumber: "+reversedDENumber
		println "params.tradeServiceId: "+params.tradeServiceId
		println "reverseDE: "+reverseDE
        ...
        def documentServiceRoute = routingInformationService.getNextMainApprover(DOCUMENT_CLASS, documentType, documentSubType1, documentSubType2, REFERENCE_TYPE.toUpperCase(), "UA_LOAN_SETTLEMENT", session.username, session.userrole.id, session.unitcode, session.dataEntryModel, session.userLevel)
        session.nextRoute = documentServiceRoute
        session.dataEntryModel << routingInformationService.getMainApprovalMode(DOCUMENT_CLASS, documentType, documentSubType1, documentSubType2, "UA_LOAN_SETTLEMENT", session.dataEntryModel.approvers)
        ...
        def productReference = routingInformationService.getProductReferences(DOCUMENT_CLASS, documentType, documentSubType1, documentSubType2, "UA_LOAN_SETTLEMENT", session.dataEntryModel, session.unitcode, session.username)
...
// get lc class and type
    ...
    def uploadDocument() {
        ...
        redirect(controller:'lcDataEntryUaLoanSettlement', action:'invokeUploadCommand',params:params)
    }
