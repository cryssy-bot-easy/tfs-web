...
class LcDataEntryAmendmentController {
...
//            session.dataEntryModel.numberOfAmendments = NumberUtils.integerFormat(dataEntryService.countNumberOfAmendments(session.dataEntryModel.documentNumber))
            //println"session.dataEntryModel.numberOfAmendments > " + session.dataEntryModel.numberOfAmendments
	...
	def viewAmendmentDataEntry() {
        //println"IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIii"
        ...
        chain(action:"viewAmendment", model: session.dataEntryModel)
	}
	
    def saveAmendmentDataEntry() {
        // get lc class and type
        String documentType = params.documentType
        String documentSubType1 = params.documentSubType1.toUpperCase()
        String documentSubType2 = params.documentSubType2
        ...
        params.productStatus = session.dataEntryModel.status
    ...
    def uploadDocument() {
        ...
        redirect(controller:'lcDataEntryAmendment', action:'invokeUploadCommand',params:params)
    }
