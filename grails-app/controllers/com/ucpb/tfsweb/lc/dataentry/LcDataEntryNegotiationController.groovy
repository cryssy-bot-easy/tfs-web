...
/**
 * <pre>
 * Program_id    : LcDataEntryNegotiationController
 * Program_name  : LcDataEntryNegotiationController
 * SCR_Number    :
 * Process_Mode  : WEB
 * Frequency     : Daily
 * Input         : N/A
 ...
 * </pre>
 */
class LcDataEntryNegotiationController {
...
//println"DETAENTRY"+session.dataEntryModel.paymentsMade
	...
	def viewNegotiationDataEntry() {
        ...
        if (params.tradeServiceId) {
            ...
            dataEntryMap.each {
                ...
                println 'session.dataEntryModel.paymentStatus ' + session.dataEntryModel.paymentStatus
                //println"DATA ENTRY:"+it
            }
        }
    ...
    def uploadDocument() {
        ...
        redirect(controller:'lcDataEntryNegotiation', action:'invokeUploadCommand',params:params)
    }
