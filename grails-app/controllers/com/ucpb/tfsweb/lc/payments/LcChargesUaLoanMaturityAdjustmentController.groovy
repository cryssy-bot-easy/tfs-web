...
class LcChargesUaLoanMaturityAdjustmentController {
...
//            }
    ...
    def viewMaturityAdjustmentCharges() {
        ...
        chain(action: "viewMaturityAdjustment", model: session.chargesModel)
    }

    def updateMaturityAdjustmentCharges() {
        //construct header title
