...
<table class="tabs_forms_table">
	...
	<tr>
		...
		<td class="input_width"> <g:select class="select_dropdown" name="bookingCurrency" from="" disabled="true"/> </td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="input_width"> <g:select class="select_dropdown" name="agriAgraBspTagging" from="['Regular']" /> </td>
	</tr>
	<tr>
		<td class="label_width"> <span class="field_label"> Payment Code </span> </td>
		<td class="input_width"> <g:select class="select_dropdown" name="paymentCode" from="['0']" /> </td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="input_width"> <g:textField class="input_field" name="transactionPostingStatus" readonly="readonly" /> </td>
	</tr>
