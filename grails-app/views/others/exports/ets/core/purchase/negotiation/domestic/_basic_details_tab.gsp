...
<table class="tabs_forms_table">
	...
	<tr>
		<td class="label_width"> <span class="field_label"> With Outstanding DBC? </span> </td>
	...
	<tr>
		...
		<td class="input_width"> <g:textField class="input_field" name="dbcNegoAmount" readonly="readonly" /> </td>
	</tr>
	<tr>
