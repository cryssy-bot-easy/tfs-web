...
<table class="tabs_forms_table">
	<tr>
		<td class="label_width"> <g:checkBox name="confirmOnly"/> &#160; <label for="confirmOnly"> Confirm Only? </label> </td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="input_width"> <g:textField class="input_field" name="processingUnitCode" readonly="readonly"/> </td>
	</tr>
	<tr>
	...
	<tr>
		<td class="label_width"> <span class="field_label"> Proceeds Amount (in Nego Currency)<span class="asterisk">*</span> </span> </td>
