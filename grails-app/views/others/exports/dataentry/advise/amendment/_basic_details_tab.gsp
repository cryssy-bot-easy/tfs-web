...
<table class="tabs_forms_table">
	<tr>
		...
		<g:if test="${ subType1.equalsIgnoreCase('Second') }">
			<td> <span class="title_label"> Other Bank Charges (for Payment via MC </span></td>
			<td> </td> 
		</g:if>	
	</tr>
	<tr>
	...
	<tr>
		...
		<g:if test="${ subType1.equalsIgnoreCase('Second')  }">	
			...
			<td> <g:textField name="totalAmountOtherBankCharges" class="field_label" /></td>
		</g:if>			
	</tr>
	<tr>
		<td> <span class="field_label"> Exporter Name </span> </td>
		<td> <g:textField name="exporterName" class="input_field" readonly="readonly" value="" maxlength="60"/> </td>
		<g:if test="${ subType1.equalsIgnoreCase('First')  }">				
			<td rowspan="2"> <span class="field_label"> Sender to Receiver Information </span> </td>
			<td rowspan="2"> <g:textArea name="senderReceiverInformation" class="textarea" rows="2"></g:textArea> </td>
		</g:if>		
	</tr>
	<tr>
		<td> <span class="field_label"> Exporter Address </span> </td>
		<td> <g:textArea name="exporterAddress" class="textarea" rows="4" readonly='readonly'> </g:textArea> </td>
	...
	<tr>
		...
		<td> <g:textField name="dateOfAmendment" class="datepicker_field" readonly="readonly" /> </td>
	</tr>
	<tr>
		<td> <span class="field_label"> Number of Amendment </span> </td>
		<td> <g:textField name="numberOfAmendment" class="input_field" readonly="readonly" /> </td>
	</tr>
	<tr>
		<td><br/></td>
	</tr>
	...
	<tr>
		...
		<td> <g:select name="lcCurrency" class="select_dropdown" from="${['PHP']}" /> </td>
	</tr>
	<tr>
	...
	<tr>
		<td> <span class="field_label"> New Exporter's Name  <g:if test="${ subType1.equalsIgnoreCase('Second') }"> <span class="asterisk"> * </span> </g:if>  </span> </td>
		<td> <g:textField name="newImporterName" class="input_field" maxlength="60"/> </td>
	</tr>
	<tr>
		<td> <span class="field_label"> New Exporter's Address <g:if test="${ subType1.equalsIgnoreCase('Second') }"> <span class="asterisk"> * </span> </g:if> </span> </td>
		<td> <g:textArea name="newImporterAddress" class="textarea" rows="2"> </g:textArea> </td>
	</tr>
	<tr>
