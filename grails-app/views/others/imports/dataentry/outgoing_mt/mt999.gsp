...
<body style="visibility: hidden;" onload="js_Load()">
	<content tag="header">
		<g:render template="../layouts/header" model="${[title : 'Outgoing MT - 999']}"/>
	</content>
    ...
    <content tag="basicDetails">
        ...
        <g:render template="../layouts/alert_confirmation" model="${[popupId:'mtPopup',
			yesBtnId:'mtConfirm',noBtnId:'mtCancel',popupTitle:'Save mt999',
			popupMessage:'Are you sure you want to save mt999?'] }"/>
    </content>
        
    <content tag="additionalResources">
    	<g:javascript src="utilities/other_imports/mt/outgoing/mt999_basic_details_utility.js"/>
    </content>
</body>
</html>