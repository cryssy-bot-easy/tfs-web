...
<g:hiddenField name="messageType" value="199"/>
<g:hiddenField name="chainName" value="viewMT199"/><%--Used for chaining in saveOutgoingMt action --%>
...
<table class="buttons_for_grid_wrapper">
	<g:if test="${tradeServiceId?.tradeServiceId != null}">
		<tr>
			<td>
				<input type="button" class="input_button2" value="View MT 199" onclick="viewOutgoingMt(199)"/>
			</td>
		</tr>	
	</g:if>
	<tr>
