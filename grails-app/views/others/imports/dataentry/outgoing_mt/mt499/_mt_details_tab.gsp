...
<g:hiddenField name="messageType" value="499"/>
<g:hiddenField name="chainName" value="viewMT499"/><%--Used for chaining in saveOutgoingMt action --%>
...
<table class="buttons_for_grid_wrapper">
	<g:if test="${tradeServiceId?.tradeServiceId != null}">
		<tr>
			<td>
				<input type="button" class="input_button2" value="View MT 499" onclick="viewOutgoingMt(499)"/>
			</td>
		</tr>	
	</g:if>
	<tr>
