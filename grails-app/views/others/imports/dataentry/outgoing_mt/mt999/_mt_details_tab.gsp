...
<g:hiddenField name="messageType" value="999"/>
<g:hiddenField name="chainName" value="viewMT999"/><%--Used for chaining in saveOutgoingMt action --%>
...
<table class="buttons_for_grid_wrapper">
	<g:if test="${tradeServiceId?.tradeServiceId != null}">
		<tr>
			<td>
				<input type="button" class="input_button2" value="View MT 999" onclick="viewOutgoingMt(999)"/>
			</td>
		</tr>	
	</g:if>
	<tr>
