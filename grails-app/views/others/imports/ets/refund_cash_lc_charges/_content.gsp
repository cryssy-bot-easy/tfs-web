<div id="body_forms">
	...
	<ul>
   		...
   		<li><a href="#refund_details_lc_tab" id="refundDetailsLcTab"><span class="tab_titles"> Refund Details for LC Amount </span></a></li>
   		...
   		<li><a href="#mode_of_refund_tab" id="modeOfRefundTab"><span class="tab_titles"> Mode Of Refund </span></a></li>
     	...
     	<g:form id="basicDetailsTabForm">
		     <div id="basic_details_tab">
		     	<g:render template="../others/imports/ets/refund_cash_lc_charges/basic_details_tab" />
		     </div> 
      	</g:form>
      	
      	<g:form id="refundDetailsLcTabForm">
		     <div id="refund_details_lc_tab">
		     	<g:render template="../others/commons/tabs/cash_lc_charges_lc_amount_details_tab" />
		     </div> 
      	</g:form>
      	
      	<g:form id="refundDetailsChargesTabForm">
		     <div id="refund_details_charges_tab">
		     	<g:render template="../others/commons/tabs/cash_lc_charges_refund_details_tab" />
		     </div> 
      	</g:form>
      	
      	<g:form id="modeOfRefundTabForm">
		     <div id="mode_of_refund_tab">
		     	<g:render template="../others/commons/tabs/cash_lc_charges_mode_of_refund_tab" />
		     </div>
      	</g:form>
