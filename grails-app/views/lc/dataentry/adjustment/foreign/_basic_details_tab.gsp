...
<table class="tabs_forms_table">
	...
	<tr>
		...
		<td><g:textField name="etsNumber" class="input_field textFormat-12" readonly="readonly" value="${tradeServiceReferenceNumber ?: etsNumber}"/></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2"><span class="field_label">Receiver’s Bank<br/>Reference Number</span></td>
		<td><g:textField name="receiversBankReferenceNumber" value="${receiversBankReferenceNumber}" class="input_field" maxlength="16"/></td>
	</tr>
	<tr>
	<tr>
		<td><span class="field_label">CIF Number</span></td>
		<td><span class="field_label right_indent">From:</span></td>
		<td><g:textField id="cifNumberFrom" name="cifNumberFrom" class="input_field" readonly="readonly" value="${cifNumberFrom ?: cifNumber}"/></td>
		<td colspan="2"><span class="field_label right_indent">To:</span></td>
		<td><g:textField id="cifNumberTo" name="cifNumberTo" class="input_field" readonly="readonly" value="${cifNumberTo}"/>
	...
	<g:if test="${!documentSubType1?.equalsIgnoreCase('CASH')}">
		<tr>
			...
			<td colspan="2"><span class="field_label right_indent">To:</span></td>
			<td><g:textField name="mainCifNumberTo" class="input_field" readonly="readonly" value="${mainCifNumberTo}"/></td>
		</tr>
		<tr>
	...
	<tr>
		...
		<td><g:textField name="processingUnitCode" class="input_field" type="text" readonly="readonly" value="${processingUnitCode}"/></td>
	...
	<tr>
		...
		<td><span class="field_label right_indent">From:</span></td>
		<td><g:textField name="faciltiyIdFrom" class="input_field" readonly="readonly" value="${faciltiyIdFrom ?: facilityId}"/></td>
		<td colspan="2"><span class="field_label right_indent">To:</span></td>
		<td><g:textField name="facilityIdTo" class="input_field" readonly="readonly" value="${facilityIdTo}"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan="2"><span class="field_label"> O/S FXLC Amount </span></td>
    ...
    <g:if test="${documentSubType1?.equalsIgnoreCase("STANDBY")}">
        <tr>
            <td colspan="2"><span class="field_label">Purpose of Standby FXLC</span></td>
            <td colspan="4"><g:textArea class="textarea" name="purposeOfStandby" value="${purposeOfStandby}" rows="4" maxlength="400"/></td>
        </tr>
    </g:if>
	<tr>
		<td colspan="2"><span class="field_label">Narrative</span></td>
		<td><g:textArea class="textarea" name="narrative" value="${narrative}" rows="4" maxlength="2000"/></td>
	</tr>
    <g:if test="${documentSubType1?.equalsIgnoreCase("STANDBY")}">
        <tr>
            <td colspan="2"><span class="field_label">Tagging of Standby FXLC</span></td>
            <td>
