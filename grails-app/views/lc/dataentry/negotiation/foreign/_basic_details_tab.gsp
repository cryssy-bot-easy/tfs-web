...
<table class="tabs_forms_table">
	...
	<tr>
		<td><span class="field_label"> O/S FXLC Balance </span><br /><span class="field_label"> (before this negotiation) </span></td>
	...
	<g:if test="${(documentSubType1 =='CASH')}">
		<tr>
			<td><span class="field_label"> AP Cash Amount <br/> (in Negotiation Currency) </span></td>
