...
<table class="tabs_forms_table">
	...
	<tr>
		...
		<td><g:textField name="type" value="${type}" class="input_field" readonly="readonly" /></td>
		<td><span class="field_label"> FXLC Tenor </span></td>
		<td><g:textField name="tenor" value="${tenor}" class="input_field" readonly="readonly" /></td>
	</tr>
	<tr>
