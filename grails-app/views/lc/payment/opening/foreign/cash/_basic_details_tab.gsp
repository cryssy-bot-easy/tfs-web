...
<table class="tabs_forms_table">
	...
	<tr>
		...
		<td><g:textField name="documentNumber" class="input_field textFormat-16" readonly="readonly" value="${documentNumber}"/> </td>
	...
	<tr>
		...
		<td>
            <%--<g:textField name="cwtFlag" class="input_field" readonly="readonly" value="${cwtFlag}"/>--%>
		...
		<td><g:textField name="outstandingBalance" value="${outstandingBalance ?: amount}" class="input_field_right numericCurrency" readonly="readonly" /></td>
	</tr>
</table>
