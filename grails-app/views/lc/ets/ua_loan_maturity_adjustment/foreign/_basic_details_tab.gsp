...
<g:javascript src="/js-temp/validation_FXLC_Ua_Loan_Maturity_Adjustment_ets.js" />
...
<g:hiddenField name="productAmount" value="${productAmount ?: negotiationAmount}" />
<%--<script type="text/javascript">--%>
    <%--var negotiationNumberString = '${negotiationNumberString}';--%>
<%--</script>--%>

<%--<g:javascript src="utilities/ets/negotiation/negotiation_basic_details_utility.js" />--%>
...
<table class="tabs_forms_table validation_table">
		...
		<tr>
			...
			<td>
			  <%--as per joey, change dropdown to textfield. value is the nego number selected from nego inquiry--%>
                          <g:textField class="input_field required" name="negotiationNumber" readonly="readonly" value="${negotiationNumber}"/>
		...
		<tr>
			...
			<td><g:textField class="input_field_right lc_amount numericCurrency" name="amount" value="${amount ?: negotiationAmount}" readonly="readonly"/></td>
		...
		<tr>
			...
			<td>
			  <g:textField class="input_field numerical_three" readonly="readonly" name="processingUnitCode" value="${processingUnitCode}" />
			</td>
			<td><span class="field_label">With Beneficiary's<br />Conformity? <span class="asterisk">*</span></span></td>
			<td>
				<g:radioGroup values="['Y', 'N']" class="required" labels="['Yes','No']" name="beneficiaryConformityFlag" value="${beneficiaryConformityFlag ?: "Y"}">
		...
		<tr>
			...
			<td><g:textField class="input_field lc_issue" name="loanMaturityDateFrom" value="${loanMaturityDateFrom ?: loanMaturityDate}" readonly="readonly"/></td>
			<td><span class="field_label right_indent">To: <span class="asterisk">*</span></span></td>
			<td><g:textField class="datepicker_field lc_expiry date required" name="loanMaturityDateTo" value="${loanMaturityDateTo}"/></td>
		</tr>
	</table>
	<br/>
