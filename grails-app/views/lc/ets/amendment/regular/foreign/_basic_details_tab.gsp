...
<table class="tabs_forms_table">
	...
	<tr>
		...
		<td class="input_width"> <g:textField class="input_field" name="expiryDate" value="${expiryDate}" readonly="readonly"/> </td>
	</tr>
	<tr>
		...
		<td class="input_width">
            <g:textField  name="facilityId" value="${facilityId}" class="input_field" readonly="readonly"/>
        </td>
	</tr>
	<tr>
