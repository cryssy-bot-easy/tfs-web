...
<table class="tabs_forms_table">
	...
	<tr>
		...
		<td><g:textField  name="etsDate" class="input_field date" value="${etsDate ?: DateUtils.shortDateFormat(new Date())}" readonly="readonly"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><g:textField name="type" class="input_field type" readonly="readonly" value="${type ?: 'CASH'}"/></td>
...
<%--		<td><g:textField name="outstandingBalance" value="${outstandingBalance}" class="input_field_right numericCurrency" readonly="readonly"/></td>--%>
		%{--<td><g:textField name="amount" value="${amount?:productAmount}" class="input_field_right numericCurrency" readonly="readonly"/></td>--}%
		<td><g:textField name="amount" value="${outstandingBalance}" class="input_field_right numericCurrency" readonly="readonly"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			<g:radioGroup class="required" name="cwtFlag" labels="['Yes','No']" values="['Y', 'N']" value="${cwtFlag ?: 'N'}">
				${it.radio} ${it.label}&#160;&#160;
			</g:radioGroup>
