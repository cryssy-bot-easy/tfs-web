...
<table class="tabs_forms_table">
	...
	<tr>
		...
		<td class="input_width"> <g:textField class="input_field input_ten" name="type" readonly="readonly" value="STANDBY"/> </td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="input_width"> 
			<%-- <tfs:lcCurrency class="select_dropdown currency" name="currency" value="${currency}"/> --%>
			<%-- Auto Complete --%>
