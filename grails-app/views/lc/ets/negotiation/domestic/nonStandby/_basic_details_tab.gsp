...
(revision)
    ...
    Program [Revision] Details: Change Outstanding DMLC Balance to Outstanding LC Amount,
...
<table class="tabs_forms_table">
	...
	<tr>
		...
		<g:if test="${documentSubType1?.equalsIgnoreCase('CASH') || documentSubType1?.equalsIgnoreCase('REGULAR')}">
            ...
            <td><g:textField name="cashAmountRegular" value="${(outstandingBalance != null ? outstandingBalance as double : 0.0)-(cashAmount != null ? cashAmount as double : 0.0)}" class="input_field_right numericCurrency" readonly="readonly" /></td>
        </g:if>
	</tr>
	<tr>
	<tr>
