...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (icAmount<=0) {
        	...
        	$("#outstandingBalanceLessIcField").hide();
        } else {
        	$("#outstandingBalanceLessIcLabel").show();
        	$("#outstandingBalanceLessIc").show();
        	$("#outstandingBalanceLessIcField").show();
        }
    });
...
<table class="tabs_forms_table">
	...
	<tr>
		...
		<%-- <td><g:select name="icNumber" from="${['Option 1', 'Option 2', 'Option 3']}" class="select_dropdown" value="${icNumber}"/> </td> --%>
		<td>
	...
	<tr>
<%--		<g:if test="${documentSubType1?.equalsIgnoreCase('REGULAR') && documentSubType2?.equalsIgnoreCase('USANCE')}">--%>
<%--			<td valign="bottom"><span class="title_label"> UA Loan Details ${tenor}</span></td>--%>
<%--		</g:if>--%>
<%--		<g:else>--%>
			<td>&#160;</td>	
<%--		</g:else>--%>
...
<%--		<td><g:textField name="loanMaturityDate" class="datepicker_field"/></td>--%>
<%--		</g:if>--%>
<%--		<g:else>--%>
				<td>&#160;</td>
				<td>&#160;</td>
<%--		</g:else>--%>
		...
		<g:if test="${documentSubType1?.equalsIgnoreCase('CASH') || documentSubType1?.equalsIgnoreCase('REGULAR')}">
			...
			%{--<td><g:textField name="apCashAmount" class="input_field numericCurrency" readonly="readonly" value="${apCashAmount}"/></td>--}%
...
<%--				<td>--%>
<%--				<g:textField name="loanTerm" class="input_field" value="${loanTerm}" />--%>
<%--				</td>--%>
<%--			</g:if>--%>
<%--			<g:else>--%>
				<td>&#160;</td>
