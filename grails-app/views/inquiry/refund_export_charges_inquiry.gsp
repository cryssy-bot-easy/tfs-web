...
<script type="text/javascript">
    ...
    var searchAllExportsUrl = '${g.createLink(controller: "inquiry", action: "searchAllExportsForRefund")}';
    var gotoOtherExportChargesUrl = '${g.createLink(controller: "product", action: "gotoRefundExportCharges")}';
</script>
