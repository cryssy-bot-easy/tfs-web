...
<head>
	...
	<g:javascript src="grids/export_advance_payment_inquiry_jqgrid.js"/>
   ...
   <script type="text/javascript">
        ...
        var refundExportAdvanceUrl = '${g.createLink(controller: "product", action: "viewExportAdvanceRefund")}';
        var searchExportAdvanceInquiry = '${g.createLink(controller: "inquiry", action: "searchExportAdvanceInquiry")}';
	</script>
...
<div id="outer_wrap">
	...
	<div id="body_forms">
        <form id="exportAdvanceInquiry" class="inquiry_form">
            <table class="body_forms_table">
                <tr>
                    <td> <span class="field_label"> CIF Name </span> </td>
                    <td>
                        <g:textField class="input_field" name="cifNameInquiry" />
                ...
                <tr>
                    <td colspan="4">
                        <table class="body_forms_table_btn">
                            <tr><td> <input type="button" class="input_button" value="Search" id="searchExportAdvance"/> </td></tr>
                            <tr><td> <input type="reset" class="input_button_negative" value="Reset" id="resetExportAdvance" /> </td></tr>
                        </table>
                    </td>
                </tr>
            </table>
		...
		<div class="grid_wrapper">
			<g:if test="${session['group']?.equalsIgnoreCase("TSD")}">
				<table id="grid_list_export_advanced_payment_main"></table>
			</g:if>
		    <g:if test="${session['group']?.equalsIgnoreCase("BRANCH")}">
				<table id="grid_list_export_advanced_payment_branch"></table>
 		 	</g:if>
			<div id="grid_pager_export_advanced_payment"></div>
		</div>	
		<br/><br />
	</div>
</div>			
