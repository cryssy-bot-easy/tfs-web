...
<table class="charges_table">
	<g:if test="${serviceType?.equalsIgnoreCase('Monitoring Refund')}">
		...
		<tr>
			...
			<td> <g:textField name="refundCurrency" class="input_field_short required" readonly="readonly"/> </td>
	...
	<g:else>
		...
		<tr>
			...
			<td><g:textField name="settlementCurrency" class="input_field_short required" readonly="readonly"/> </td>
...
<div class="grid_wrapper">
	<table id="grid_list_payment_edit"></table>
</div>
<table>
<g:if test="${serviceType?.equalsIgnoreCase('Monitoring Refund')}">
	<tr>
...
<table class="buttons_for_grid_wrapper">
	<tr><td><g:submitToRemote class="input_button_long" id="popup_btn_ar_monitoring_payment_accounting_entries" value="Process Payment"/></td></tr>
</table>
<br />
