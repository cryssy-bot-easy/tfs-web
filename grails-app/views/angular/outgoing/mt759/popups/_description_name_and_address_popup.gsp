<div id="popup_description" class="popup_div_override">
    ...
    <div class="popup_divider">
        ...
        <g:textArea name="fileIdentificationDescription" ng-show="md.popupTitle == 'File Identification'" ng-model="md.popupDescription" class="textarea_add_instructions" disabled="disabled"/>
        <span></span>
        <br /><br />
