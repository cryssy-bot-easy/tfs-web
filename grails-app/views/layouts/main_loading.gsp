...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
        ...
        <link rel="stylesheet" href="${resource(dir: 'fonts', file: 'Lato-Regular.ttf')}" type="text/css"/>
        ...
        <script type="text/javascript">
			...
			var autoCompleteFirmLibUrl = '${g.createLink(controller:'autoComplete', action:'autoCompleteFirmLib')}';
        ...
        <g:if test="${!(documentClass in ['DA', 'DP', 'OA', 'DR'] && serviceType.toUpperCase() in ['NEGOTIATION', 'NEGOTIATION_ACKNOWLEDGEMENT', 'NEGOTIATION ACKNOWLEDGEMENT'])}">
        <script type="text/javascript">
