...
<g:hiddenField name="form" value="mt202Details" />
...
<%--		<td><g:select from="${['Option A-SWIFT Code','Option B-Location','Option D-Name']}" noSelection="['':'SELECT ONE']" name="accountWithBank" class="select_dropdown"/></td>--%>
	...
	<tr>
		<td><span class="field_label small_margin_left"><g:radio name="accountWithBankFlag" class="accountWithBankFlag" value="2" />&#160;&#160;Party Identifier</span></td>
		<td><g:textField class="input_field" name="accountPartyIdentifier" /></td>
	</tr>
	<tr>
		<td><span class="field_label_indent"> &#160;&#160;Location</span> </td>
