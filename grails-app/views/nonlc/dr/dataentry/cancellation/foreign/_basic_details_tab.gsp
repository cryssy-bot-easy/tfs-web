...
<%--		<td><span class="field_label">Will the FX Non-LC documents be transferred to another bank?</span></td>--%>
<%--		<td id="letterOfTransferFlag">--%>
<%--			<g:radioGroup name="willTheFxNonLcDocumentsBeTransferredToAnotherBankFlag" labels="['Yes', 'No']" values="['Y','N']" value="${willTheFxNonLcDocumentsBeTransferredToAnotherBankFlag}">--%>
<%--				${it.radio} ${it.label} &#160;&#160;--%>
<%--			</g:radioGroup>--%>
<%--		</td>--%>
	</tr>
