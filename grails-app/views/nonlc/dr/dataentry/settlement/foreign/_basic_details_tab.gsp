...
<table class="tabs_forms_table">
	...
	<tr>
		...
		<td><g:textField class="input_field" name="etsNumber" value="${etsNumber}" readonly="readonly"/></td>
	...
	<tr>
		...
		<td class="input_width"><g:textField class="input_field" name="importerCifNumber" value="${importerCifNumber}" readonly="readonly"/><a href="#" id="nonLcImporterCifNumberButton" class="search_btn popup_btn_cif_normal">search button</a></td>
...
<%--		<td class="input_width"><g:textField class="input_field required" name="importerName" value="${importerName}"/></td>--%>
		<td valign="top" rowspan="2"><g:textArea class="textarea required" name="importerName" value="${importerName}" rows="2" maxlength="60"/></td>
...
<%--		<td class="input_width"><g:textField class="input_field" name="portOfOrigin" readonly="readonly"/></td>--%>
    ...
    <tr>
        <td class="label_width"><span class="field_label">Beneficiary Account Number</span></td>
        <%--		<td class="input_width"><g:textField class="input_field required" name="beneficiaryName" value="${beneficiaryName}" /></td>--%>
        <td class="input_width"><g:textField class="input_field" name="beneficiaryAccountNumber" value="${beneficiaryAccountNumber}" /></td>
...
<%--		<td class="input_width"><g:textField class="input_field required" name="beneficiaryName" value="${beneficiaryName}" /></td>--%>
        ...
        <td><input type="hidden" id="tempfcdu" name="tempfcdu" value="${tempfcdu}"/>
	...
	<tr>
		...
		<td>
			<g:textArea class="textarea" name="beneficiaryAddress" value="${beneficiaryAddress}" readonly="readonly" rows="2"/>
			<a href="javascript:void(0)" class="search_btn" id="popup_btn_beneficiary_address">...</a>
		</td>
        <td class="label_width valign_top"><span class="field_label small_margin_left">Reimbursing Bank Currency<span class="asterisk">*</span></span></td>
        ...
        <td valign="top"><g:textField id="reimbursingBankCurrency" name="reimbursingBankCurrency" value="${reimbursingBankCurrency}" class="input_field required" readonly="readonly" /></td>
	</tr>
</table>
<br/><br/>
...
<%-- NOTE: temporarily commented out due to error in display.  --%>

	/*
		Functions for importer cif number and importer cif code
	*/
	/*function onImporterCifNumberChange(){
		if("" == $("#importerCifNumber").val()){
			$("#importerCbCode").select2("enable");
		}else{
			$("#importerCbCode").select2("disable");
		}
	}

	function onImporterCbCodeChange(){
		if("" == $("#importerCbCode").val()){
			$("#importerCifNumber").removeAttr("disabled");
			$("#nonLcImporterCifNumberButton").show();
		}else{
			$("#importerCifNumber").attr("disabled","");
			$("#nonLcImporterCifNumberButton").hide();
		}
	}
	
	$("#importerCifNumber").change(onImporterCifNumberChange);
    $("#importerCbCode").change(onImporterCbCodeChange);*/
