...
<%--				</g:if>--%>
		...
		<div id="basic_details_tab">						
			<form id="basicDetailsTabForm">
				<g:if test="${serviceType?.equalsIgnoreCase('Settlement')}">
					<g:render template="../nonlc/dr/dataentry/settlement/foreign/basic_details_tab" />
				</g:if>
				<g:elseif test="${serviceType?.equalsIgnoreCase('Negotiation')}">
					<g:render template="../nonlc/dr/dataentry/negotiation/foreign/basic_details_tab" />
				</g:elseif>
				<g:elseif test="${serviceType?.equalsIgnoreCase('Cancellation')}">
					<g:render template="../nonlc/dr/dataentry/cancellation/foreign/basic_details_tab" />
				</g:elseif>
			</form>
		</div>
