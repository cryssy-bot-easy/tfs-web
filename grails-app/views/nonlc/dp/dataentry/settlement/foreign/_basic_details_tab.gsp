...
(revision)
    ...
    [Revised date:] 04/03/2018
    Program [Revision:] add new Fields Importer Code and commodity code.
...
<%--		<td class="input_width"><g:textField class="input_field required" name="importerName" value="${importerName}"/></td>--%>
		<td class="input_width"><g:textArea class="textarea required" name="importerName" value="${importerName}" rows="2"/></td>
	</tr>
	<tr>
