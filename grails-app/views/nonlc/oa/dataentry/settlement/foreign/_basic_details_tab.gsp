...
<%--		<td class="input_width"><g:textField class="input_field" name="portOfOrigin" readonly="readonly"/></td>--%>
		<td class="input_width">
			<input class="tags_country select2_dropdown bigdrop required" name="originalPort" id="originalPort"/>
	...
	<tr>
		<td/>
		<td/>
		<td><g:textArea name="reimbursingBankName" value="${reimbursingBankName}" class="input_field" readonly="readonly" rows="2"/></td>
	</tr>
	<tr>
		<td></td>
		<td>
    ...
    <tr>
        ...
        <td class="input_width"><g:textField class="input_field" name="beneficiaryAccountNumber" value="${beneficiaryAccountNumber}" />
    </td>
    </tr>
	<tr>
...
<%--		<td class="input_width"><g:textField class="input_field required" name="beneficiaryName" value="${beneficiaryName}" /></td>--%>
	...
	<tr>
        ...
        <td><span class="field_label">Account Number<span class="asterisk">*</span></span></td>
	...
	<tr>
        ...
        <td><span class="field_label">GL Bank Code</span></td>
        <td><g:textField id="glCode" name="glCode" value="${glCode}" class="input_field" readonly="readonly" /></td>
	</tr>
	<tr>
    	<td/>
        <td><span class="field_label">Reimbursing Bank Currency<span class="asterisk">*</span></span></td>
