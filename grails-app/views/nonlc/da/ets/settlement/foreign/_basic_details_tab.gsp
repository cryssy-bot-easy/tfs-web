...
<table class="tabs_forms_table settlement_mode">
	<tr>
		<td class="label_width"><span class="left_padding">Main CIF Number</span></td>
		<td>
	...
	<tr>
		<td><span class="left_padding">Main CIF Name</span></td>
...
<%--	<tr>--%>
<%--		<td><span class="left_padding">Facility Type</span></td>--%>
<%--		<td>--%>
<%--			<g:select name="facilityType" value="${facilityType}" class="select_dropdown" from="${['FFT', 'FTF']}"/>--%>
<%--		</td>--%>
<%--	</tr>--%>
<%--	<tr>--%>
<%--		<td><span class="field_label left_padding">Facility ID<span class="asterisk">*</span></span></td>--%>
<%--		<td>--%>
<%--			<g:select name="facilityId" value="${facilityId}" class="select_dropdown" from="${[]}" noSelection="['':'SELECT ONE...']"/>--%>
<%--			<a href="javascript:void(0)" class="search_btn popup_btn_facility" id="facility_lookup"> Search/Look-up Button </a>	--%>
<%--		</td>--%>
<%--	</tr>--%>
<%--	<tr>--%>
<%--		<td>--%>
<%--			<span class="left_padding">If over-availment: With prior</span>--%>
<%--			<br/>--%>
<%--			<span class="left_padding">	approval in the CRAM?</span>--%>
<%--		</td>--%>
<%--		<td>--%>
<%--			<g:radioGroup name="cramFlag" value="${cramFlag}" labels="['Yes', 'No']" values="['Y','N']" >--%>
<%--				${it.radio} ${it.label} &#160;&#160;--%>
<%--			</g:radioGroup>--%>
<%--		</td>	--%>
<%--	<tr>--%>
