...
<%--        </td>--%>
	...
	<tr>
		...
		<td class="input_width"><g:textField class="input_field length20 required" name="remittingBankReferenceNumber" value="${remittingBankReferenceNumber}" maxlength="25"/></td>
	</tr>
	<tr>
...
<%--		<td class="input_width"><g:select noSelection="['':'SELECT ONE...']" class="select_dropdown" name="currency" value="${currency}" from="${['PHP','USD','EUR']}"/></td>--%>
	...
	<tr>
        ...
        <td class="input_width">
            <g:textField class="input_field" name="importerCifNumber" value="${importerCifNumber}" readonly="readonly"/>
...
<%--		<td class="input_width"><g:select class="select_dropdown" name="originalPort" value="${originalPort}" from="${['Option 1','Option 2','Option 3']}"/></td>--%>
	...
	<tr>
		...
		<td class="input_width"><g:textArea class="textarea required" name="importerName" value="${importerName}" rows="2" maxlength="50"/></td>
	...
	<tr>
		<td class="label_width valign_top"><span class="field_label"> Sender to Receiver<br />Information</span></td>
		<td class="input_width">
