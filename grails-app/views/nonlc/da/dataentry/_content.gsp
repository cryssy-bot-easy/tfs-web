	...
	<div id="body_forms_header">
		...
		<table id="header_details2">
			<tr>
				...
				<td>
				  	<g:textField name="cifNumber" class="input_field textFormat-7 ${serviceType == 'Negotiation Acknowledgement' ? 'required' : ''}" readonly="readonly" value="${cifNumber}"/>
			  		<g:if test="${serviceType == 'Negotiation Acknowledgement'}">
	...
	<div id="tab_container"> 
		<ul id="tabs">
			...
			<g:elseif test="${serviceType?.equalsIgnoreCase('Settlement')}">
				...
				<%-- <li><a href="#mt400_202_details_tab" id="mt400_202DetailsTab"><span class="tab_titles"> MT400 / MT202 Details<br/>&#160; </span></a></li> --%>
...
<%--				<li><a href="#mt202_details_tab" id="mt202DetailsTab"><span class="tab_titles"> MT202 Details<br/>&#160; </span></a></li>--%>
...
<%--				</g:if>--%>
		...
		<div id="basic_details_tab">						
			<form id="basicDetailsTabForm">
				<g:if test="${serviceType?.equalsIgnoreCase('Cancellation')}">
					<g:render template="../nonlc/da/dataentry/cancellation/foreign/basic_details_tab" />
				</g:if>
				<g:elseif test="${serviceType?.equalsIgnoreCase('Negotiation Acknowledgement')}">
					<g:render template="../nonlc/da/dataentry/negotiation/acknowledgement/foreign/basic_details_tab" />
				</g:elseif>
				<g:elseif test="${serviceType?.equalsIgnoreCase('Negotiation Acceptance')}">
					<g:render template="../nonlc/da/dataentry/negotiation/acceptance/foreign/basic_details_tab" />
				</g:elseif>
				<g:elseif test="${serviceType?.equalsIgnoreCase('Settlement')}">
					<g:render template="../nonlc/da/dataentry/settlement/foreign/basic_details_tab" />
				</g:elseif>
			</form>
		</div>
		...
		<g:if test="${serviceType?.equalsIgnoreCase('Settlement')}">
			...
			<%-- MT400 / 202  TAB --%>
			<%-- <div id="mt400_202_details_tab">
				<form id="mt400_202DetailsTabForm">
					<g:render template="../nonlc/commons/tabs/mt400_202_details_tab" />
				</form>
			</div> --%>
			...
			<%-- MT202 TAB 
			<div id="mt202_details_tab">
				<form id="mt202DetailsTabForm">
					<g:render template="../nonlc/commons/tabs/mt202_details_tab" />
				</form>
			</div>
