...
<%--<table class="tabs_forms_table">
	...
	<tr>
		...
		<td class="input_width"> <g:textField class="input_field numericQuantity" name="numberOfFreeFloatDays" value="${numberOfFreeFloatDays}"/> </td>
	</tr>
</table>
...
<script>
    ...
    $(document).ready(function() {
        $("#bookingCurrency").setCurrencyDropdownUsdPhpOnly($(this).attr("id")).select2('data',{id: '${currency}'});
