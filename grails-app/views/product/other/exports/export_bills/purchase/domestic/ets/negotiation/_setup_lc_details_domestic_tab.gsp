...
<table class="tabs_forms_table">
	...
	<tr>
		...
		<td class="input_width"> <g:textField class="input_field required" name="lcNumber" value="${lcNumber}" maxlength="21"/> </td>
	</tr>
	<tr>
...
<%--	</tr>--%>
	<tr>
		...
		<td class="input_width"> <g:textArea class="textarea_long_upper" name="issuingBankAddress" value="${issuingBankAddress}" maxlength="350"/> </td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="input_width"> <g:textArea class="textarea_long_upper required" name="lcDescriptionOfGoods" value="${lcDescriptionOfGoods}" maxlength="6500"/> </td>
	</tr>
</table>
