...
<table class="tabs_forms_table">
    ...
    <tr>
        ...
        <td>
            <input class="tags_bank select2_dropdown bigdrop required" name="receivingBank" id="receivingBank" />
        </td>
    </tr>
    <tr>
    ...
    --%>
        <tr>
            ...
            <td><g:textArea name="orderingAddress" class="textarea_long required" rows="4" readonly="readonly"/></td>
        </tr>
    </g:if>
    <g:else>
        <tr>
            ...
            <td>
                ...
                <input class="tags_accountNumber select2_dropdown bigdrop required" name="orderingAccountNumber" id="orderingAccountNumber" />
            </td>
        </tr>
    <%--
...
--%>
        <tr>
            <td class="vtop"><span class="field_label">Ordering Customer<span class="asterisk">*</span><br/> Address</span></td>
            <td><g:textArea name="orderingAddress" value="${orderingAddress}" class="textarea_long required" rows="4"/></td>
        </tr>
    </g:else>
    <g:if test="${serviceType?.equalsIgnoreCase('export advance refund')}">
        <tr>
    ...
    <tr>
        ...
        <td><g:select name="accountWithInstitution" value="${accountWithInstitution}" class="select_dropdown required" from="${['ACC-1','ACC-2']}" noSelection="['':'SELECT ONE...']" /></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><g:textField name="beneficiaryName" value="${beneficiaryName}" class="input_field required" maxlength="60" /></td>
    </tr>
    <tr>
        <td class="vtop"><span class="field_label">Beneficiary Customer<span class="asterisk">*</span><br/>Address</span></td>
        <td><g:textArea name="beneficiaryAddress" value="${beneficiaryAddress}" class="textarea_long required" rows="4" /></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><g:select name="detailsOfCharges" value="${detailsOfCharges}" class="select_dropdown required" from="${['SHA']}" noSelection="['':'SELECT ONE...']" /></td>
    </tr>
    <tr>
        <td valign="top"><span class="field_label"> Sender to Receiver *MUST HAVE CODE* <span class="asterisk"> * </span> <br />Information</span></td>
        <td><g:textArea name="senderToReceiverInformation" value="${senderToReceiverInformation}" class="textarea_long required" rows="4"/></td>
    </tr>
</table>
