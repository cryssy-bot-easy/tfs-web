...
<table class="tabs_forms_table">
	...
	<tr>		
		...
		<td><g:textField class="input_field required" name="beneficiary" value="${beneficiary ?: sellerName}" /></td>
	</tr>
    <tr>	
		<td><span class="field_label"> Account Number <span class="asterisk"> * </></span></td> 
		<td>
			<%-- Edit by Kyle and Pauline: made this field required--%>
            <g:textField class="input_field required" maxlength="12" name="pddtsAccountNumber" value="${pddtsAccountNumber}" style="float: left;"/>
	...
	<tr>		
		...
		<td><g:textField class="input_field" name="byOrder" value="${byOrder ?: buyerName}" readonly="readonly" /></td>
	</tr>
    <tr>	
