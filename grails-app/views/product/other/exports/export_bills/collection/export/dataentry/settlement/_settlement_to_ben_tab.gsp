...
<%--
 * PROLOGUE
 * SCR/ER Description: To save the special rate edited by the user
 *	[Revised by:] Jesse James Joson
 *	Program [Revision] Details: Use the sepecial rate edited by the user to show in special rate column
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        if ('${paymentStatus}' == 'NO_PAYMENT_REQUIRED' && ($("#grid_list_charges_payment").length > 0 || $("#grid_list_proceeds_payment_summary").length > 0)){
