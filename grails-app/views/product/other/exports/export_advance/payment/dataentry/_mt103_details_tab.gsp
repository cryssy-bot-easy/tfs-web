...
--%>
    ...
    <tr>
        ...
        <td><g:textField name="beneficiaryName" value="${beneficiaryName}" class="input_field" maxlength="60" /></td>
    </tr>
    <tr>
	...
	<tr>
		<td valign="top"><span class="field_label"> Sender to Receiver <span class="asterisk"> * </span> <br />Information</span></td>
		<td>
	...
	<tr>
		<td>&#160;</td>
		<td>
			<g:textArea name="senderToReceiverInformationTextArea" value="${senderToReceiverInformationTextArea}" class="textarea_long" rows="4"/>
		</td>
	</tr>
    <tr>
