...
<script type="text/javascript">
    var settlementToBenGridUrl = '${g.createLink(controller: "exportsRefund", action: (referenceType == 'PAYMENT') ? "displaySettlementToBenDataEntryGrid" : "displaySettlementToBenEtsGrid")}';
    var convertSettlementRatesUrl = '${g.createLink(controller:'foreignExchange', action:'convertSettlementRates')}';

    var computeTotalRefundUrl = '${g.createLink(controller:'exportsRefund', action:'computeTotalRefund')}';
