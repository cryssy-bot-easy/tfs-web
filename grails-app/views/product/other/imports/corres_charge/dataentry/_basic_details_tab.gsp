...
<table class="tabs_forms_table">
	<tr>
		...
		<td class="label_width"><g:textField name="etsNumber" value="${serviceInstructionId}" class="input_field" readonly="readonly"/></td>
	</tr>
	<tr>
		<td><span class="field_label">e-TS Date </span></td>
		<td><g:textField name="etsDate" value="${etsDate}" class="input_field" readonly="readonly"/></td>
	</tr>
	<tr>
		<td><span class="field_label">Process Date </span></td>
		<td><g:textField name="processDate" value="${processDate}" class="input_field" readonly="readonly"/></td>
	</tr>
	<tr>
    ...
    <tr>
        ...
        <td>
            <g:textField name="amount" class="input_field_right" value="${amount}" readonly="readonly"/>
	...
	<tr>
		...
		<td>
			<g:radioGroup values="${['Y','N']}" labels="${['Yes','No']}" class="required" name="remitCorresCharges" id="remitCorresCharges" value="${remitCorresCharges ?: 'N'}"><label>${it.radio}&#160;${it.label}&#160;&#160;&#160;</label></g:radioGroup>
		</td>
	</tr>
...
<script>
    ...
    $(document).ready(function() {
        <%--$("#reimbursingBank").setDepositoryBankDropdownWithCurrencyCorres($(this).attr("id")).select2('data',{id: '${reimbursingBank}'});--%>
        $("#reimbursingBank").setDepositoryBankDropdownWithCurrencyCorres($("#currency").val()).select2('data',{id: '${reimbursingBank}'});
