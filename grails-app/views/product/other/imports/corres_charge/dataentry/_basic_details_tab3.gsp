...
<g:hiddenField name="withoutReference" value="true" />
...
<table class="tabs_forms_table">
	<tr>
		...
		<td class="input_width"><g:textField name="processDate" value="${processDate ?: DateUtils.shortDateFormat(new Date())}" class="input_field" readonly="readonly"/></td>
	</tr>

    <tr>
        <td><span class="field_label">Document Number</span></td>
        <td>
            <g:textField name="documentNumber" value="${documentNumber}" class="input_field" />
        </td>
    </tr>
    ...
    <tr>
        ...
        <td><g:textField name="outstandingCorresCharge" class="input_field_right numericCurrency" readonly="readonly" value="0.00"/></td>
    </tr>

    <tr>
        <td><span class="field_label">Settlement Currency<span class="asterisk">*</span></span></td>
        <td><input class="tags_currency select2_dropdown bigdrop required" name="settlementCurrency" id="settlementCurrency" /></td>
    </tr>
    <tr>
