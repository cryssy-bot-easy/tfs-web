...
<table>
	...
	<tr>
		...
		<td><g:textField class="input_field" name="transactionType" readonly="readonly" value="${transactionType != null ? transactionType : (documentClass + ' ' + approvedTradeServices?.serviceType?.toString()?.replace('[','')?.replace(']','')) }"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><g:textField class="input_field" name="amount" readonly="readonly" value="${amount}"/></td>
	</tr>
	<tr>
		<td><span class="field_label">Process Date</span></td>
		<td><g:textField class="input_field" name="processDate" readonly="readonly" value="${processDate != null ? processDate : etsDate}"/></td>
	</tr>
	<tr>
		<td><span class="field_label">Expiry Date</span></td>
		<td><g:textField class="input_field" name="processingUnitCode" readonly="readonly" value="${expiryDate}"/></td>
	</tr>
</table>
