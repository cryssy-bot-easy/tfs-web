...
<g:render template="../product/other/imports/refund/popups/update_charges_popup" />
<g:javascript src="new/refund/refund_charges_utils.js" />
<script>
    var recomputeNewChargesUrl = '${g.createLink(controller: "refund", action: "recomputeNewCharges")}';
    var getBookedRatesUrl = '${g.createLink(controller: "refund", action: "onChangeTransaction")}';
    var applyUpdatedChargesUrl = '${g.createLink(controller: "refund", action: "applyUpdatedCharges")}';

    var savedNewChargesUrl = '${g.createLink(controller: "refund", action: "getSavedNewCharges")}';
