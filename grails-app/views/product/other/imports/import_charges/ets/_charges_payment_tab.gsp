...
<table class="charges_table">
    ...
    <tr>
        ...
        <td><g:textField class="input_field_right" value="${remainingBalance}" name="remainingBalance"
...
<table class="charges_table">
    <tr>
        ...
        <td class="editable disabled"><g:textField class="input_field_right numericCurrency"
                                                   name="amountOfPaymentCharges"/></td>
    </tr>
</table>
...
<div class="chargesPaymentButtons">
    <table>
        <tr>
            <td><input type="button" class="input_button_long" id="popup_btn_mode_of_payment_charges"
                       value="Add Settlement Charges" disabled="disabled"/></td>
        </tr>
    </table>
</div>
<br/>
...
<table class="charges_payment_table">
    <tr>
        <td width="195"><span class="field_label">Total Amount of Payment - Charges <br/>(in Settlement Currency)</span>
        </td>
        <td><g:textField name="totalAmountOfPaymentCharges" value="${totalAmountOfPaymentCharges}"
                         class="input_field_right" readonly="readonly"/></td>
    </tr>
    <tr>
        <td><span class="field_label">Excess Amount - Charges <br/>(in Settlement Currency)</span></td>
        <td><g:textField name="excessAmountCharges" value="${excessAmountCharges}" class="input_field_right"
                         readonly="readonly"/></td>
    </tr>
</table>
<br/>
...
<g:if test="${(("DATAENTRY".equals(referenceType) || "DATA_ENTRY".equals(referenceType)) &&
    ...
    <table class="buttons_for_grid_wrapper saveButtonsContainer">
        ...
        <tr>
            <%-- BUTTON --%>
            <td><input type="button" id="cancelConfirmChargesPayment" class="input_button_negative" value="Cancel"/>
            </td>
        </tr>
    </table>
