...
<g:hiddenField name="documentNumber" value="${documentNumber}"/>
    ...
    <table class="charges_table">
        <tr>
            ...
            <td>
                <span class="charges_currency" id="totalAmtDueCurrency">PHP</span>
            </td>
        ...
        %{--<tr>--}%
            ...
            %{--<td>--}%
                %{--<span class="charges_currency" id="remainingBalanceCurrency">PHP</span>--}%
            %{--</td>--}%
...
<br/>
<g:hiddenField value="PHP" name="settlementCurrency" id="settlementCurrency" />
<table class="charges_table">
    <tr>
        <td width="195"><span class="field_label"> Amount of Payment - Charges <br/>(in Additional Charges Currency) </span> </td>
        <td>
            <span class="charges_currency" id="amountOfPaymentChargesSettlementCurrency">PHP</span>
        </td>
...
%{--<g:if test="${!(documentClass in ['BP', 'BC'])}">--}%
    <g:if test="${(("DATAENTRY".equals(referenceType) || "DATA_ENTRY".equals(referenceType)) &&
            !(documentClass in ['BP', 'BC', 'EXPORT_CHARGES', 'IMPORT_CHARGES'])) ||
