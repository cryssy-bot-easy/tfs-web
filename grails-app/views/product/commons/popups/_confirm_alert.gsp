...
<div class="popup_div_alert confirm_alert_div" id="${confirmDivId}">
    ...
    <ul class="popup_buttons_alert" id="${confirmDivId == "routeDiv" ? "confirm_buttons" : ""}">
        <li>
            %{--<input type="button" class="input_button_alert confirmYes" value="Yes" id="${confirmId}"/>--}%
            <input type="button" class="input_button_alert cancelAction" value="Yes" id="${confirmId}Cancel"/>
            <input type="submit" class="input_button_alert saveAction" value="Yes" id="${confirmId}" />
