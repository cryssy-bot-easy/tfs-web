...
function constructChargesAndRatesPopup() {
    $.post(getBookedRatesUrl, {tradeServiceId: $("#transaction").val()}, function(data) {
        ...
        var params = {currency: $("#currency").val()};
...
function applyUpdatedCharges() {
    var params = {tradeServiceId: $("#tradeServiceId").val(), settlementCurrency: $("#currency").val(), transactionType: $("#transaction option:selected").text()};
