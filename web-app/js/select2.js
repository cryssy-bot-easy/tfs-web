...
//temporarily commented out to avoid js error (page does not load properly because of this error)
//            if (select) {
...
//            }
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        // single
        data: function(value) {
            // marv.25Mar2013 - hack: will not execute code portion of id value.id is blank
...
//            in case of errors: kindly uncomment this portion of the code and comment the above
            var data;
