...
function setupBankCommission(settlementCurrency) {
    ...
    $("#bankCommission").val(formatCurrency(defaultValue));
...
function setupCilexFee(settlementCurrency) {
    ...
    $("#cilexFee").val(formatCurrency(defaultValue));
...
function setupDocumentaryStamp(settlementCurrency) {
    ...
    $("#documentaryStamp").val(formatCurrency(defaultValue));
...
function setupInterestDue(settlementCurrency) {
    $("#interestDue").val("");
    var defaultValue = getDefaultValues("INTEREST");
    $("#interestDue").val(defaultValue);
...
function setupAdvisingFee(settlementCurrency) {
    ...
    $("#advisingFee").val(formatCurrency(defaultValue));
...
function setupConfirmingFee(settlementCurrency) {
    ...
    $("#confirmingFee").val(formatCurrency(defaultValue));
...
function constructAmountList() {
    ...
    if ($("#cilexFee").val() != undefined && otherSettlementCurrencyUsed() != "false") {
    ...
    if ($("#notarialFee").val() != undefined) {
        amounts.push($("#notarialFee").val().replace(/,/g, "*"));
    }
    if ($("#interestDue").val() != undefined) {
        amounts.push($("#interestDue").val().replace(/,/g, "*"));
    }
    ...
    if ($("#bookingCommission").val() != undefined) {
    	amounts.push($("#bookingCommission").val().replace(/,/g, "*"));
    }
    if ($("#bspFee").val() != undefined) {
    	amounts.push($("#bspFee").val().replace(/,/g, "*"));
    }
