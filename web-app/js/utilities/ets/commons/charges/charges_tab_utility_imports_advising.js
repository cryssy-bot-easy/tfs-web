...
function setupCharges(settlementCurrency) {
    ...
    $("#ADVISING-EXPORTCurrency, #esportsAdvisingFeePopupFieldCurrency").val(settlementCurrency);
    if ($("#OTHER-EXPORT").val() != undefined) {
        $("#OTHER-EXPORTCurrency, #otherAdvisingFeeCurrency").val(settlementCurrency);
    }
    if ($("#CABLE").val() != undefined) {
...
function constructAmountList() {
    ...
    if ($("#CABLE").val() != undefined) {
        amounts.push($("#CABE").val().replace(/,/g, "*"));
    }
