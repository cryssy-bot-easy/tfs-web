...
function setupCharges(settlementCurrency) {
    ...
    var productamount = Number($("#amount").val().replace(/,/g,''));
    ...
    $.post(recomputeCurrency_BP_DOMESTIC_SETTLEMENT_Url, {
        ...
        currency: currency,
        settlementCurrency: 'PHP'}, function (data) {
    ...
    $("#SUPCurrency, #suppliesFeePopupFieldCurrency").val(settlementCurrency);
