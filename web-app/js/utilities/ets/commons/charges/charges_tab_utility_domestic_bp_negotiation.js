...
function setupCharges(settlementCurrency) {
    ...
    $.post(recomputeCurrency_BP_DOMESTIC_NEGOTIATION_Url, {
    ...
    $("#POSTAGECurrency, #postageFeePopupFieldCurrency,#postageFeeCurrency ").val(settlementCurrency);
    $("#CILEXCurrency, #cilexFeePopupFieldCurrency, #cilexNetBankComCurrency, #cilexCWTCurrency, #cilexGrossBankComCurrency").val(settlementCurrency);
    $("#REMITTANCECurrency, #remittanceFeePopupFieldCurrency, #remittanceFeeCurrency").val(settlementCurrency);
