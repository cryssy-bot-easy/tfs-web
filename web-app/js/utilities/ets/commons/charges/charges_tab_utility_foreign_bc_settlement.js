/**
	...
	Project: WEB
	Project Name: charges_tab_utility_foreign_bc_settlement.js
...
function setupCharges(settlementCurrency) {
    ...
    $.post(recomputeCurrency_BC_FOREIGN_SETTLEMENT_Url, {
        ...
        settlementCurrency: $("#settlementCurrency").val()}, function (data) {
...
function constructAmountList() {
    ...
    if ($("#POSTAGE").val() != undefined) {
        amounts.push($("#POSTAGE").val().replace(/,/g, "*"));
    }
...
function otherSettlementCurrencyUsed(){
    ...
    console.log("withOtherCurrency:"+withOtherCurrency)
